package com.stackroute.springbootwithmultipledatasource.config;
...
@EnableJpaRepositories(
  ...
  basePackages = { "com.stackroute.springbootwithmultipledatasource.accountdb.repository" }
)
public class AccountDataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean accountEntityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder
				...
				.packages("com.stackroute.springbootwithmultipledatasource.accountdb.entity")
				.build();
	}
